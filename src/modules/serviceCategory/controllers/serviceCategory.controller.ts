...
import { serviceCategoryQueryDto } from '@/modules/serviceCategory/dtos';
import { createServiceCategory } from '@/modules/serviceCategory/dtos/create-serviceCategory.dto';
import { updateServiceCategoryDtoDto } from '@/modules/serviceCategory/dtos/update-service_table.dto';
...
class ServiceCategoryController {
  ...
  async createServiceCategory(req: Request, res: Response, next: NextFunction) {
    try {
      const dto = createServiceCategory.parse(req.body);
      res
  ...
  async updateServiceCategory(req: Request, res: Response, next: NextFunction) {
    try {
      const dto = updateServiceCategoryDtoDto.parse(req.body);
      res
        .status(HttpStatusCode.OK)
        .json(
